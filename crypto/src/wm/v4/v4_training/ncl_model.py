"""
V4.D Diversity World Model -- Multi-Head NCL Architecture
...
class DiversityWorldModel(nn.Module):
    ...
    - Frozen from V4 checkpoint (mode='frozen_backbone')
    """
    ...
    def load_backbone_from_v4(self, v4_state_dict: dict, freeze: bool = False):
        """
        Load backbone weights from a trained V4 checkpoint.
        ...
        print(f"  [OK] Loaded {loaded} params from V4 checkpoint")
...
if __name__ == "__main__":
    ...
    print(f"V4.D Diversity Model Parameters: {count_parameters(model):,}")
    ...
    print("\n[OK] V4.D Diversity model sanity check passed.")
