"""
V4.2.D Diversity World Model -- Multi-Head NCL Architecture
...
class DiversityWorldModel(nn.Module):
    ...
    - Frozen from V4.2.1 checkpoint (mode='frozen_backbone')
    """
    ...
    def load_backbone_from_v4(self, v4_state_dict: dict, freeze: bool = False):
        """
        Load backbone weights from a trained V4.2 checkpoint.
        ...
        print(f"  [OK] Loaded {loaded} params from V4.2.1 checkpoint")
...
if __name__ == "__main__":
    ...
    print(f"V4.2.D Diversity Model Parameters: {count_parameters(model):,}")
    ...
    print("\n[OK] V4.2.D Diversity model sanity check passed.")
