"""
V4.2 World Model — Mamba-RSSM Hybrid with Multi-Horizon Prediction + XD Anti-Memorization
...
try:
    ...
    from v4_2_training.components import MambaBlock, TwoHotSymlog, SwiGLU, MLPHead, RMSNorm
    from v4_2_training.settings import *
    from v4_2_training.settings import get_feature_config, XD_DROPOUT_RATE, XD_NOISE_STD, BASE_DIM


class MambaWorldModel(nn.Module):
    """
    The V4.2 World Model + XD Anti-Memorization.
...
if __name__ == "__main__":
    ...
    print(f"V4.2 Mamba world model sanity check passed (features={n_feat}).")