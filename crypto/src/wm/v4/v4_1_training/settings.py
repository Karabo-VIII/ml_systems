...
V4 Settings — Mamba SSM World Model (SOTA 2025/26)



Architecture: Mamba SSM + RSSM latent space

Hardware Target: RTX 4060 (8GB) + i9, Windows 11

Data: 10 assets, 18 features (13 base + 5 cross-asset), ~30M total bars
...
MODEL_DIR = PROJECT_ROOT / "models" / "wm" / "v4" / "v4_1"

LOG_DIR = PROJECT_ROOT / "logs" / "v4" / "v4_1"
...
try:
    ...
    _assert_canonical(globals(), version_name="v4_1")
except ImportError:
