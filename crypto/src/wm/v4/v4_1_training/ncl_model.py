"""
V4.1.D Diversity World Model -- Multi-Head NCL Architecture
...
class DiversityWorldModel(nn.Module):
    ...
    - Frozen from V4.1.1 checkpoint (mode='frozen_backbone')
    """
    ...
    def load_backbone_from_v4(self, v4_state_dict: dict, freeze: bool = False):
        """
        Load backbone weights from a trained V4.1 checkpoint.
        ...
        print(f"  [OK] Loaded {loaded} params from V4.1.1 checkpoint")
    ...
    def forward_train(self, obs_seq, asset_id, masked_obs_seq=None, temporal_ctx_drop=0.0):
        ...
        # Posterior reads MASKED input_obs not raw obs_seq.
...
if __name__ == "__main__":
    ...
    print(f"V4.1.D Diversity Model Parameters: {count_parameters(model):,}")
    ...
    print("\n[OK] V4.1.D Diversity model sanity check passed.")
