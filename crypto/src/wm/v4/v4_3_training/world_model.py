"""
V4.3 World Model — Mamba-RSSM Hybrid with Multi-Horizon Prediction + XD Anti-Memorization
...
try:
    ...
    from v4_3_training.components import MambaBlock, TwoHotSymlog, SwiGLU, MLPHead, RMSNorm
    from v4_3_training.settings import *
    from v4_3_training.settings import get_feature_config, XD_DROPOUT_RATE, XD_NOISE_STD, BASE_DIM


class MambaWorldModel(nn.Module):
    """
    The V4.3 World Model + XD Anti-Memorization.
    ...
    def forward_train(
        ...
        # Posterior reads MASKED input_obs base features. Fixed 2026-05-21 RED-team audit.
...
if __name__ == "__main__":
    ...
    print(f"V4.3 Mamba world model sanity check passed (features={n_feat}).")