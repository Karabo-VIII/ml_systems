"""
V8.2 World Model Trainer -- Neural ODE Edition + XD Anti-Memorization

Architecture: Neural ODE with RK4 solver for continuous-time market dynamics
Version: v8_2_neural_ode_antifragile
...
class CheckpointManager:
    ...
    def __init__(self, save_dir: Path, keep_top_k: int = 3, prefix: str = "v8_2_f18"):
...
def train_world_model(n_features: int = 18, use_revin: bool = False):
    """
    Anti-fragile training loop for V8.2 NeuralODE-RSSM.
    ...
    ckpt_prefix = f"v8_2_{feat_tag}"
    log_path = setup_logging(LOG_DIR, f"v8_2_{feat_tag}_train")
    ...
    print("=" * 70)
    print("  V8.2 WORLD MODEL TRAINER (Neural ODE | Anti-Fragile)")
    print("=" * 70)
    ...
    print_antifragile_header("V8.2", af_config)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="V8.2 World Model Trainer")
