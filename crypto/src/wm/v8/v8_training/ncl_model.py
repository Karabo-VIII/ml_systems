"""
V8.D Diversity World Model -- Multi-Head NCL Architecture
...
class DiversityWorldModel(nn.Module):
    ...
    - Frozen from V8 checkpoint (mode='frozen_backbone')
    """
    ...
    def load_backbone_from_v8(self, v8_state_dict: dict, freeze: bool = False):
        """
        Load backbone weights from a trained V8 checkpoint.
        ...
        print(f"  [OK] Loaded {loaded} params from V8 checkpoint")
    ...
    def forward_train(self, obs_seq, asset_id, masked_obs_seq=None, temporal_ctx_drop=0.0):
        ...
        obs_with_asset = torch.cat([obs_seq, asset_emb], dim=-1)
...
if __name__ == "__main__":
    ...
    print(f"V8.D Diversity Model Parameters: {count_parameters(model):,}")
    ...
    print("\n[OK] V8.D Diversity model sanity check passed.")
