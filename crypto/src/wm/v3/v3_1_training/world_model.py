"""
V3.1 World Model — WaveNet-GRU Hybrid with RSSM + XD Anti-Memorization
...
try:
    ...
    from v3_1_training.components import (
        RMSNorm,
        WaveNetTCN,
        MultiScaleAggregator,
        CausalGRU,
    ...
    from v3_1_training.settings import *


class WaveNetGRUWorldModel(nn.Module):
    """V3.1: WaveNet-GRU Hybrid World Model with RSSM latents + XD Anti-Memorization."""
    ...
    def forward_train(
        ...
        # Posterior sees only BASE features of the MASKED obs (input_obs) — not
        # raw obs_seq. Using raw obs_seq lets z_post copy back masked values,
        # defeating block-mask MAE. Fixed 2026-05-21 RED-team audit.
...
if __name__ == "__main__":
    ...
    print(f"V3.1 WaveNet-GRU World Model Parameters: {count_parameters(model):,}")
    ...
    print("V3.1 WaveNet-GRU world model sanity check passed.")
