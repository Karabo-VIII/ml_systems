"""
V3.2.D Diversity World Model -- Multi-Head NCL Architecture
...
class DiversityWorldModel(nn.Module):
    ...
    - Frozen from V3.2.1 checkpoint (mode='frozen_backbone')
    """
    ...
    def load_backbone_from_v3(self, v3_state_dict: dict, freeze: bool = False):
        """
        Load backbone weights from a trained V3.2 checkpoint.
        ...
        print(f"  [OK] Loaded {loaded} params from V3.2.1 checkpoint")
    ...
    def forward_train(self, obs_seq, asset_id, masked_obs_seq=None, temporal_ctx_drop=0.0):
        ...
        # raw obs_seq. Fixed 2026-05-21 RED-team audit.
...
if __name__ == "__main__":
    ...
    print(f"V3.2.D Diversity Model Parameters: {count_parameters(model):,}")
    ...
    # Test V3.2 backbone loading
    print("\n  Testing V3.2 backbone loading...")
    ...
    print("\n[OK] V3.2.D Diversity model sanity check passed.")
