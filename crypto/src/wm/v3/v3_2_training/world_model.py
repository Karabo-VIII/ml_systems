"""
V3.2 World Model — WaveNet-GRU Hybrid with RSSM + XD Anti-Memorization
...
try:
    ...
    from v3_2_training.components import (
        RMSNorm,
        WaveNetTCN,
        MultiScaleAggregator,
        CausalGRU,
    ...
    from v3_2_training.settings import *


class WaveNetGRUWorldModel(nn.Module):
    """V3.2: WaveNet-GRU Hybrid World Model with RSSM latents + XD Anti-Memorization."""
    ...
    def forward_train(
        ...
        # Posterior reads MASKED input_obs base features (not raw obs_seq).
        # Fixed 2026-05-21 RED-team audit — block-mask MAE leak through posterior.
...
if __name__ == "__main__":
    ...
    print(f"V3.2 WaveNet-GRU World Model Parameters: {count_parameters(model):,}")
    ...
    print("V3.2 WaveNet-GRU world model sanity check passed.")
