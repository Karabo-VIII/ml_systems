"""
V3.3 World Model Trainer -- WaveNet-GRU-RSSM + XD Anti-Memorization

Architecture: WaveNet-style Gated Dilated Convolutions + GRU + RSSM
Version: v3_3_wavenet_gru_rssm_antifragile
...
class CheckpointManager:
    ...
    def __init__(self, save_dir: Path, keep_top_k: int = 3, prefix: str = "v3_3_f18"):
...
def train_world_model(n_features: int = 18, use_revin: bool = False):
    """
    Anti-fragile training loop for V3.3 WaveNet-GRU-RSSM.
    ...
    ckpt_prefix = f"v3_3_{feat_tag}"
    log_path = setup_logging(LOG_DIR, f"v3_3_{feat_tag}_train")
    ...
    print("=" * 70)
    print("  V3.3 WORLD MODEL TRAINER (WaveNet-GRU-RSSM | Anti-Fragile)")
    print("=" * 70)
    ...
    print_antifragile_header("V3.3", af_config)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="V3.3 World Model Trainer")
