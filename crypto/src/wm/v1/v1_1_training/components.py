...
# 2026-05-21: prior inline copy in V1.1 used Jensen-WRONG decode
#             [symexp(E[buckets]) instead of E[symexp(buckets)]], biasing
#             record-holder predictions toward zero on fat-tail returns.
#             Import path goes through src/wm/_shared/twohot.py now.
# ==============================================================================
