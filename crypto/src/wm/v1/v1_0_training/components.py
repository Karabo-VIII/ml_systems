...
# ==============================================================================
# TWO-HOT SYMLOG ENCODING — canonical, Jensen-correct decode
# Lives in src/wm/_shared/twohot.py (consolidation 2026-05-21). Importing here
# preserves `from components import TwoHotSymlog` callsites in every V1-V25
# version while ensuring the math comes from one place.
# ==============================================================================
