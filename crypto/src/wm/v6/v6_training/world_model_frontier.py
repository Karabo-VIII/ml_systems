...
# V6 frontier uses Transformer blocks from V1 (V6's own components don't have them)
import importlib.util as _ilu
_v1_comp_file = str(Path(__file__).resolve().parent.parent.parent / "v1" / "v1_0_training" / "components.py")
_spec = _ilu.spec_from_file_location("v1_components", _v1_comp_file)
_v1_mod = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_v1_mod)
CausalTransformerBlock = _v1_mod.CausalTransformerBlock
RotaryEmbedding = _v1_mod.RotaryEmbedding
