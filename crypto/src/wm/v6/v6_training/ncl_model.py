"""
V6.D Diversity World Model -- Multi-Head NCL Architecture (CausalJEPA variant)
...
class DiversityWorldModel(nn.Module):
    ...
    - Loaded from V6 checkpoint (load_backbone_from_v6())
    ...
    def load_backbone_from_v6(self, v6_state_dict: dict, freeze: bool = False):
        """
        Load backbone weights from a trained V6 checkpoint.
        ...
        print(f"  [OK] Loaded {loaded} params from V6 checkpoint")
...
if __name__ == "__main__":
    ...
    print(f"V6.D Diversity Model Parameters: {count_parameters(model):,}")
    ...
    # Test V6 backbone loading
    print("\n  Testing V6 backbone loading...")
    ...
    print("\n[OK] V6.D Diversity model sanity check passed.")
