"""
V6.1 World Model Trainer -- Causal JEPA + Adversarial + Anti-Memorization (Anti-Fragile Edition)
...
Key V6.1 innovations (added vs V6):
  ...
  - Dynamic checkpoint prefix: v6_1_f13 or v6_1_f18
...
class CheckpointManager:
    ...
    V6.1-specific: also saves/loads discriminator optimizer state.
    Uses dynamic prefix (e.g. v6_1_f18, v6_1_f13) for feature ablation.
    """
...
def train_world_model(n_features: int = 18, use_revin: bool = False):
    """
    Anti-fragile training loop for V6.1 Causal JEPA + Adversarial + Anti-Memorization.
    ...
    log_path = setup_logging(LOG_DIR, f"v6_1_{feat_tag}_train")
    ...
    print("=" * 70)
    print("  V6.1 WORLD MODEL TRAINER (Causal JEPA + Adversarial + Anti-Memorization | Anti-Fragile)")
    print("=" * 70)
    ...
    print_antifragile_header("V6.1", af_config)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="V6.1 World Model Trainer (Anti-Memorization)")
