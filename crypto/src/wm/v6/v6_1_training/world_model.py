"""
V6.1 World Model -- Causal JEPA + Adversarial Time Shuffling + Anti-Memorization
...
Key Fix vs V6:
  V6.1 adds feature-decoupled anti-memorization:
...
class CausalJEPAWorldModel(nn.Module):
    """V6.1: Causal JEPA + Adversarial Time Shuffling + Anti-Memorization world model.
...
if __name__ == "__main__":
    ...
    print(f"V6.1 Causal JEPA+Adversarial+AntiMem World Model Parameters: {total_params:,}")
    ...
    print("\nV6.1 Causal JEPA+Adversarial+AntiMem world model sanity check passed.")
